...
// per model, refreshing. 3 models: sensenova-6.7-flash-lite, sensenova-u1-fast (multimodal),
// deepseek-v4-flash (resold). OpenAI-compat. Base ends at root; runner + discovery append /v1.
