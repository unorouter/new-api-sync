...
function toMetadata(entry: LiteLLMEntry): SourceMetadata {
  ...
  // An "output cap" equal to the context window AND implausibly large is litellm
  // mirroring one published number into both fields, not a real ceiling (every xAI
