...
const CURATED: Record<string, SourceMetadata> = {
  ...
  "2dn": { series: "SDXL", mode: "image", description: "2DN is a NAI-based model that is capable of generating high-quality semi-realistic images." },
  "526mix-animated": { series: "Stable Diffusion", mode: "image", description: "The goal of this model was to anchor 526Mix's whimsical and artistic personality into anime. 526Mix can do a pretty cool anime style (and other 2D styles), but it can be a bit unreliable at times. ..." },
  "a-zovya-rpg-inpainting": { series: "Stable Diffusion", mode: "image", description: "The inpainting version of A-Zovya RPG" },
  "aam-xl": { series: "SDXL", mode: "image", description: "Anime screencap model, brought to you by the creator of DreamShaper" },
  "absolutereality": { series: "Stable Diffusion", mode: "image", description: "That feeling when you wake up after a dream.  This is a fantastic sd1.5 realism bought to you by the creator of DreamShaper" },
  "abyss-orangemix": { series: "Stable Diffusion", mode: "image", description: "A model trained to create CG anime characters" },
  "acertainthing": { series: "Stable Diffusion", mode: "image", description: "An improved version of Anything v3 made with ACertainThing, focusing on scenes rather than characters" },
  "aio-pixel-art": { series: "Stable Diffusion", mode: "image", description: "Stable Diffusion fine tuned on pixel art sprites and scenes" },
  "albedobase-xl-sdxl": { series: "SDXL", mode: "image", description: "SDXL Model that doesn't require a refiner." },
  "albedobase-xl-31": { series: "SDXL", mode: "image", description: "SDXL Model that doesn't require a refiner. This is the 3.1 version." },
  "amponyxl": { series: "Pony", mode: "image", description: "Anime model based on Pony Diffusion XL - remember to use the score prompts to get this to go properly" },
  "analog-diffusion": { series: "Stable Diffusion", mode: "image", description: "A dreambooth model trained on a diverse set of analog photographs" },
  "analog-madness": { series: "Stable Diffusion", mode: "image", description: "A very versatile model, the more powerfull prompts you give, the better results. Capable of creating both NSFW and SFW images but also great scenery, both in landscape and portrait." },
  "animagine-xl": { series: "SDXL", mode: "image", description: "Animagine XL is the sophisticated open-source anime text-to-image model, building upon the capabilities of its predecessor, Animagine XL 2.0. Developed based on Stable Diffusion XL, this iteration ..." },
  "anime-pencil-diffusion": { series: "Stable Diffusion", mode: "image", description: "A dreambooth finetune of stable diffusion 1.5 model that will output stuff in anime pencil concept drawing style." },
  "anygen": { series: "Stable Diffusion", mode: "image", description: "A best of both worlds - merging the anime of Anything v3 with Protogens photorealism - VAE is included" },
  "anylora": { series: "Stable Diffusion", mode: "image", description: "This is good for inference (again, especially with styles) even if I made it mainly for training. It ended up being super good for generating pics and it's now my go-to anime model. It also eats ve..." },
  "anything-diffusion": { series: "Stable Diffusion", mode: "image", description: "Highly detailed Anime styled generations" },
  "anything-diffusion-inpainting": { series: "Stable Diffusion", mode: "image", description: "The inpainting version of Anything Diffusion" },
  "anything-v5": { series: "Stable Diffusion", mode: "image", description: "Anything V5, see the project homepage" },
  "app-icon-diffusion": { series: "Stable Diffusion", mode: "image", description: "Dreambooth model fine tuned on mobile app icons" },
  "art-of-mtg": { series: "Stable Diffusion", mode: "image", description: "Experimenal model, based on ~5000 arts for cards from Magic: the Gathering game on top of SD1.5 model. Large variety of cards from 2014 to 2022 was used. Logos, guild/clan icons and mana symbols we..." },
  "aurora": { series: "Stable Diffusion", mode: "image", description: "Aurora is a Stable Diffusion model, similar to its predecessor Kenshi, with the goal of capturing my own feelings towards the anime styles I desire.The name Aurora, which means 'dawn' in Latin, rep..." },
  "babes": { series: "Stable Diffusion", mode: "image", description: "Trained on 1600 images from a few styles(see trigger words), with an enhanced realistic style, in 4 cycles of training. Trained on 576px and 960px, 80+ hours of successful training, and countless h..." },
  "bb95-furry-mix-v14": { series: "Stable Diffusion", mode: "image", description: "This model is a mix of various furry models." },
  "bigasp": { series: "SDXL", mode: "image", description: "BigASP is a photorealistic model designed for generating high-quality images with a variety of prompt lengths and amounts of detail." },
  "blank-canvas-xl": { series: "SDXL", mode: "image", description: "Another model from RCNZ, this one is a true generalist, able to do realism, anime, and cartoons" },
  "blendermix-pony": { series: "Pony", mode: "image", description: "This PonyXL checkpoint should create a blender animation style look. Model was merged using my loras (Fugtrup, Nyl2, RadRoachHD) and AutismMix. I also added a tiny pinch of DucHaiten-GameArt to add..." },
  "bweshmix": { series: "Stable Diffusion", mode: "image", description: "Should be able to do very good anime 2.5D illustration style by default. And also accepts artist and style prompts easily. So you can make more 2d or artistic styles. Please don't expect super clea..." },
  "camelliamix-25d": { series: "Stable Diffusion", mode: "image", description: "Semi-realistic model, Camellia Mix 2.5D V2" },
  "cetus-mix": { series: "Stable Diffusion", mode: "image", description: "A popular anime model" },
  "cheese-daddys-landscape-mix": { series: "Stable Diffusion", mode: "image", description: "This model is tweak and more merges mainly intended for landscapes, but works decent for people" },
  "cheyenne": { series: "SDXL", mode: "image", description: "A model for European Comic lovers" },
  "comic-diffusion": { series: "Stable Diffusion", mode: "image", description: "Western Comic book style" },
  "counterfeit": { series: "Stable Diffusion", mode: "image", description: "Counterfeit is anime style Stable Diffusion model" },
  "cyberrealistic-pony": { series: "Pony", mode: "image", description: "Cyberrealistic Pony is a semi-realistic Pony model capable of SFW and NSFW portraits as well as scenery." },
  "cyriousmix": { series: "Stable Diffusion", mode: "image", description: "Mostly NSFW, semi-realistic anime characters" },
  "dan-mumford-style": { series: "Stable Diffusion", mode: "image", description: "Model trained with a dataset of DanMumford Style images, courtesy of Flonix" },
  "deliberate-30": { series: "Stable Diffusion", mode: "image", description: "Based on the already popular model Deliberate, this model is a more refined version of it." },
  "deliberate-inpainting": { series: "Stable Diffusion", mode: "image", description: "The inpainting version of Deliberate" },
  "double-exposure-diffusion": { series: "Stable Diffusion", mode: "image", description: "The Double Exposure Diffusion model, trained specifically on images of people and a few animals" },
  "dreamlike-diffusion": { series: "Stable Diffusion", mode: "image", description: "Dreamlike Diffusion 1.0 is SD 1.5 fine tuned on high quality art, made by dreamlike.art" },
  "dreamshaper": { series: "Stable Diffusion", mode: "image", description: "Merged model mix of Midnight mixer, roboEtics, f222, elldrethSLucidMix, Seek.ART Mega, rpg, hassanBlend, modelshoot and roboDiffusion" },
  "dreamshaper-inpainting": { series: "Stable Diffusion", mode: "image", description: "The inpainting version of DreamShaper" },
  "dreamshaper-xl": { series: "SDXL", mode: "image", description: "DreamShaper is a general purpose SD model that aims at doing everything well, photos, art, anime, manga. It's designed to go against other general purpose models and pipelines like Midjourney and D..." },
  "duchaiten": { series: "Stable Diffusion", mode: "image", description: "DucHaiten's character generation model" },
  "duchaiten-classic-anime": { series: "Stable Diffusion", mode: "image", description: "DucHaiten's classic anime charecter model, similar to 80's/90's artwork" },
  "duchaiten-gameart-unreal-pony": { series: "Pony", mode: "image", description: "This is a 3D PonyXL model, based on the AAA game quality of Unreal Engine 5." },
  "dungeons-and-diffusion": { series: "Stable Diffusion", mode: "image", description: "Generates D&D styled characters, trained on art commissions. *many* species and classes available, see homepage" },
  "dungeons-n-waifus": { series: "Stable Diffusion", mode: "image", description: "A handpicked and curated merge of the best of the best in fantasy world, character & creature design. Should serve as a bit of a swiss army knife / multi-tool to create any and all fantasy art, cha..." },
  "edge-of-realism": { series: "Stable Diffusion", mode: "image", description: "A spin off from Level4. Built to produce high quality photos. Sometimes photos will come out as uncanny as they are on the edge of realism." },
  "eimis-anime-diffusion": { series: "Stable Diffusion", mode: "image", description: "This model is trained with high quality and detailed anime images" },
  "elysium-anime": { series: "Stable Diffusion", mode: "image", description: "Anime version of Elysium, detailed versatile anime style." },
  "epic-diffusion": { series: "Stable Diffusion", mode: "image", description: "Epic Diffusion is a general purpose model based on Stable Diffusion 1.x intended to replace the official SD releases as your default model. It is focused on providing high quality output in a wide ..." },
  "epic-diffusion-inpainting": { series: "Stable Diffusion", mode: "image", description: "The inpainting version of Epic Diffusion" },
  "ether-real-mix": { series: "Stable Diffusion", mode: "image", description: "Ether Real Mix is a realistic to semi-realistic anime style model tuned with the flexibility for general purpose use (hopefully). It still has some shortcomings inherit to anime models such as bias..." },
  "experience": { series: "Stable Diffusion", mode: "image", description: "A generalist model with a slight leaning towards science-fiction and 3d renders" },
  "expmix-line": { series: "Stable Diffusion", mode: "image", description: "Realistic anime styled drawings with extra emphasis on outlines" },
  "faetastic": { series: "Stable Diffusion", mode: "image", description: "A beautiful mixed model (22 mixes) including Noise Offset to create a wide-range of images" },
  "fantasy-card-diffusion": { series: "Stable Diffusion", mode: "image", description: "fantasy trading card style art, trained on all currently available Magic: the Gathering card art" },
  "flat-2d-animerge": { series: "Stable Diffusion", mode: "image", description: "This is a merge of some random anime based and cartoon based models to achieve a somewhat cartoony anime style, more similar to what you would actually see in anime as opposed to the more common hy..." },
  "flux1-schnell-fp8-compact": { series: "FLUX", mode: "image", description: "FLUX.1 [schnell] is a 12 billion parameter rectified flow transformer capable of generating images from text descriptions. For more information, please read our blog post. https://blackforestlabs.ai/" },
  "fustercluck": { series: "SDXL", mode: "image", description: "SDXL Model for cartoony style. If it's not cartoony enough, you may need to add 'anime, cartoon' to the front of the positive prompt to push the image in the right direction" },
  "galena-redux": { series: "Stable Diffusion", mode: "image", description: "This is an NSFW prone model. It is meant to generate primarily women and NSFW scenarios. This was made with the new base model merged together, alongside several style LoRA's." },
  "ghibli-diffusion": { series: "Stable Diffusion", mode: "image", description: "fine-tuned Stable Diffusion model trained on images from Studio Ghibli feature films" },
  "ghostmix": { series: "Stable Diffusion", mode: "image", description: "This Checkpoint works well on both SFW and NSFW" },
  "grapefruit-hentai": { series: "Stable Diffusion", mode: "image", description: "Grapefruit aims to be a hentai model with a bright and more softer anime style." },
  "gta5-artwork-diffusion": { series: "Stable Diffusion", mode: "image", description: "This model was trained on the loading screens, gta storymode, and gta online DLCs artworks. Which includes characters, background, chop, and some objects. The model can do people and portrait prett..." },
  "hasdx": { series: "Stable Diffusion", mode: "image", description: "He merged a few checkpoints and got something buttery and amazing. Does great with things other then people too. It can do anything really. It doesn't need crazy prompts either. Keep it simple. No ..." },
  "hassaku-xl": { series: "SDXL", mode: "image", description: "Hassaku aims to be a model with a bright, clear anime style." },
  "healys-anime-blend": { series: "Stable Diffusion", mode: "image", description: "This is a blend of some anime models mixed with 'realistic' stuff" },
  "holymix-ilxl": { series: "SDXL", mode: "image", description: "HolyMix Illustrious XL is a high-contrast, flat shading anime model. It supports multiple characters in the same image, as well as many more artist tags and characters as compared to Pony models." },
  "hrl": { series: "Stable Diffusion", mode: "image", description: "Hyper Realistic Looking" },
  "icbinp-i-cant-believe-its-not-photography": { series: "Stable Diffusion", mode: "image", description: "Following on from Gorilla With A Brick, merged in 10 more photorealistic models at various weights, and some more noise offset to create something that when prompted for photorealism will make you ..." },
  "icbinp-xl": { series: "SDXL", mode: "image", description: "The SDXL follow up to ICBINP, now with higher resolution and better realism" },
  "icomix": { series: "Stable Diffusion", mode: "image", description: "Comic style mix" },
  "icomix-inpainting": { series: "Stable Diffusion", mode: "image", description: "The inpainting version of iCoMix" },
  "illuminati-diffusion": { series: "Stable Diffusion", mode: "image", description: "Illuminati Diffusion is a latent text-to-image diffusion model that has been conditioned on high aesthetic synthetic images through fine-tuning. It was trained on 82,000 images locally with a singl..." },
  "inkpunk-diffusion": { series: "Stable Diffusion", mode: "image", description: "inspired by Gorillaz art, FLCL and Yoji Shinkawa. Trained on images generated from Midjourney" },
  "jim-eidomode": { series: "Stable Diffusion", mode: "image", description: "I have created something amazing that creates very stylized images, especially digital art. The model is good at creating animals, women, men, fantastic landscapes and much more." },
  "kaynegillustriousxl": { series: "SDXL", mode: "image", description: "Anime-style model, excellent for close-up portraits." },
  "lawlass-yiff-mix": { series: "Stable Diffusion", mode: "image", description: "Based on yiffy-e18 and Anything, produces sfw/nsfw furry anthro artworks of different styles with consistant quality, while maintaining details on stuff like clothes, background, etc. with simpler ..." },
  "liberty": { series: "Stable Diffusion", mode: "image", description: "A merge with over 23 other models with a methodical, careful and genuine approach. Freedom of prompting art or photo or both, landscapes or backgrounds or interiors, people or entities or scenes, s..." },
  "lyriel": { series: "Stable Diffusion", mode: "image", description: "This model is generally designed for portraits and full-length anime style photos. Fantastic landscapes are quite decent. And it doesn't require kilometer-long queries to get a high-quality result." },
  "majicmix-realistic": { series: "Stable Diffusion", mode: "image", description: "A good looking model, suitable for NSFW and dark scene." },
  "meinamix": { series: "Stable Diffusion", mode: "image", description: "MeinaMix's objective is to be able to do good art with little prompting." },
  "mhxl-aventis-horizon": { series: "SDXL", mode: "image", description: "Generalist model, focusing on semi-realistic yet stylized generations." },
  "midjourney-paintart": { series: "Stable Diffusion", mode: "image", description: "Midjourney v4 painting style" },
  "modernart-diffusion": { series: "Stable Diffusion", mode: "image", description: "You can use this model to generate modernart style images" },
  "moonmix-fantasy": { series: "Stable Diffusion", mode: "image", description: "This model is the result of merging several checkpoint models. See homepage for details." },
  "movie-diffusion": { series: "Stable Diffusion", mode: "image", description: "Movie Diffusion is SD 1.5 trained on 35mm film stills from popular movies." },
  "natvis": { series: "SDXL", mode: "image", description: "Realistic finetune of SDXL, with an emphasis on natural language prompting. Can produce both SFW and NSFW images." },
  "neurogen": { series: "Stable Diffusion", mode: "image", description: "This model gives a very good detail of skin and textures. Great for close-up photorealistic portraits as well as various characters and models." },
  "neverending-dream": { series: "Stable Diffusion", mode: "image", description: "This is a dream that you will never want to wake up from. A NeverEnding Dream.  Similar to Dreamshaper, but able to use danbooru tags" },
  "new-era": { series: "SDXL", mode: "image", description: "NEW ERA (New Era Retro Anime) is a anime model that is designed to generate high-quality anime images with a retro anime aesthetic." },
  "noob-v-pencil-xl": { series: "SDXL", mode: "image", description: "Vibrant anime-style images. Based on NoobAI-XL" },
  "noobevo": { series: "SDXL", mode: "image", description: "Anime-styled model, with an emphasis on vibrant colors and detailed renders" },
  "ntr-mix-il-noob-xl": { series: "SDXL", mode: "image", description: "NTR Mix Illustrious Noob XL is a anime model that can generate stylized anime images, both SFW and NSFW. It can generate both singular portraits and images with multiple characters in them." },
  "pastel-mix": { series: "Stable Diffusion", mode: "image", description: "The model is trained with beautiful, artist-agnostic watercolor images using the midjourney method" },
  "perfect-world": { series: "Stable Diffusion", mode: "image", description: "The pursuit of perfect balance between realism and anime, a semi-realistic model aimed to achieve beautiful realistic faces with sexy hentai bodies." },
  "photon": { series: "Stable Diffusion", mode: "image", description: "Another fantastic realism model" },
  "poison": { series: "Stable Diffusion", mode: "image", description: "Anything Diffusion fine-tuned to produce high-quality realistic anime styled images" },
  "pony-diffusion-xl": { series: "Pony", mode: "image", description: "Pony Diffusion V6 is a versatile SDXL finetune capable of producing stunning SFW and NSFW visuals of various anthro, feral, or humanoids species and their interactions based on simple natural langu..." },
  "ppp": { series: "Stable Diffusion", mode: "image", description: "PPP is a realistic model merge, tested and tweaked for human females. Mostly based on NSFW models" },
  "prefect-pony": { series: "Pony", mode: "image", description: "Anime Pony model with an emphasis on NSFW and LoRA support" },
  "pretty-25d": { series: "Stable Diffusion", mode: "image", description: "Realistic anime/cartoon styled drawings" },
  "project-unreal-engine-5": { series: "Stable Diffusion", mode: "image", description: "This checkpoint is trained to look like Unreal Engine 5 renders" },
  "quiet-goodnight-xl": { series: "SDXL", mode: "image", description: "SDXL Model for anime, bought to you from the maker of ICBINP" },
  "real-dos-mix": { series: "Stable Diffusion", mode: "image", description: "As it is a semi-realistic model, we do not recommend inappropriate exposure." },
  "realbiter": { series: "Stable Diffusion", mode: "image", description: "This blend model aims to achieve versatility in generating images that are almost realistic but with a touch of fantasy and a polished aesthetic. It performs well with both illustrations and simula..." },
  "realism-engine": { series: "Stable Diffusion", mode: "image", description: "This new model was fine-tuned using a vast collection of public domain images, ensuring that it can generate images across a wide range of contexts. While it may not be as strong in generating abst..." },
  "realistic-vision": { series: "Stable Diffusion", mode: "image", description: "Model for creating photorealistic humans" },
  "realistic-vision-inpainting": { series: "Stable Diffusion", mode: "image", description: "The inpainting version of Realistic Vision" },
  "reliberate": { series: "Stable Diffusion", mode: "image", description: "Reliberate is not a new version of Deliberate. I separate both evolutions / elaborations from each other, and made Reliberate model for those who need to work with photographic style. Yes, you can ..." },
  "rev-animated": { series: "Stable Diffusion", mode: "image", description: "This model is mainly intended for Portraits and Full Body Anime-like pictures. Fantasy landscapes are decent." },
  "rpg": { series: "Stable Diffusion", mode: "image", description: "portraits of charecters in the style of the game Baldur's Gate. check homepage for a massive prompt guide" },
  "sci-fi-diffusion": { series: "Stable Diffusion", mode: "image", description: "A Sci-Fi themed model trained on SD 1.5 with a 26K+ image dataset" },
  "sd-silicon": { series: "Stable Diffusion", mode: "image", description: "SD-Silicon: A series of general-purpose models based off the experimental automerger, autoMBW." },
  "sdxl-10": { series: "SDXL", mode: "image", description: "The base SDXL 1.0 model." },
  "something": { series: "Stable Diffusion", mode: "image", description: "A lot of things are being discovered lately, such as a way to merge model using mbw automatically, offset noise to get much darker result, and even VAE tuning. This anime model is intended to use a..." },
  "stable-cascade-10": { series: "Stable Cascade", mode: "image", description: "This model is built upon the Wurstchen architecture and its main difference to other models like Stable Diffusion is that it is working at a much smaller latent space." },
  "stable-diffusion-inpainting": { series: "Stable Diffusion", mode: "image", description: "Generalist model specialized for modifying areas of existing images" },
  "swamponyxl": { series: "Pony", mode: "image", description: "Realistic finetune of Pony Diffusion V6, with an emphasis on asian likeness." },
  "toonyou": { series: "Stable Diffusion", mode: "image", description: "Silly, stylish, and.. kind of cute? A bit of detail with a cartoony feel." },
  "tunix-pony": { series: "Pony", mode: "image", description: "Semi-realistic stylized PonyXL finetune" },
  "uhmami": { series: "Stable Diffusion", mode: "image", description: "a blend of anime-focused models with a semi-realistic aesthetic, combining 3D digital imagery with photography. It allows the use of prompts based on booru tags, similar to the novelai model, resul..." },
  "ultraspice": { series: "SDXL", mode: "image", description: "Ultraspice is a highly realistic SDXL model." },
  "unstable-diffusers-xl": { series: "SDXL", mode: "image", description: "the unstable models are a collection of checkpoints where limitations cease to exist and creativity knows no limits. This checkpoint defies restrictions and empowers you to generate anything your i..." },
  "unstable-ink-dream": { series: "Stable Diffusion", mode: "image", description: "Create a variety of styles including realistic photos, realistic drawings, and animations like last three fig" },
  "urpm": { series: "Stable Diffusion", mode: "image", description: "Model for creating photorealistic humans" },
  "vector-art": { series: "Stable Diffusion", mode: "image", description: "This is a style model for Stable Diffusion 2.1 mimicking vector style." },
  "wai-ani-nsfw-ponyxl": { series: "Pony", mode: "image", description: "WAI-ANI-NSFW-PONYXL is a Pony finetuned for NSFW anime-style generations" },
  "wai-cute-pony": { series: "Pony", mode: "image", description: "Anime Pony model, with an emphasis on cute female figures" },
  "waifu-diffusion": { series: "Stable Diffusion", mode: "image", description: "Anime styled generations." },
  "western-animation-diffusion": { series: "Stable Diffusion", mode: "image", description: "Comicbook and Western Animation Style Model" },
  "white-pony-diffusion-4": { series: "Pony", mode: "image", description: "Realistic Pony model with an incredibly strong emphasis on Asian people." },
  "woop-woop-photo": { series: "Stable Diffusion", mode: "image", description: "A model trained to make detailed, anatomically-accurate (hands, faces, genitals, etc) illustrations of humans and non-humans alike" },
  "yiffy": { series: "Stable Diffusion", mode: "image", description: "Furry styled generations." },
  "zavychromaxl": { series: "SDXL", mode: "image", description: "ZavyChromaXL is generalist model with a focus on vibrant colors and detailed renders. It is capable of generating both stylized and realistic images" },
  "zeipher-female-model": { series: "Stable Diffusion", mode: "image", description: "For creating images of nude solo women. Also known as f222" },
