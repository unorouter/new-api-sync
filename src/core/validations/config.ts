...
// prettier-ignore
const ModelMetadataSchema = T.Object({ maxOutputTokens: Opt(T.Integer({ minimum: 1 })), isReasoning: Opt(T.Boolean()), maxImageInputs: Opt(T.Integer({ minimum: 1 })), supportedParams: Opt(T.Array(str, { minItems: 1 })) });
