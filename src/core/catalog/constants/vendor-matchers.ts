...
export const VENDOR_MATCHERS: Record<string, VendorMatcher> = {
  ...
  openai: { modelPatterns: ["gpt","o1-","o1:","o3","o4-","chatgpt","sora","text-embedding-3","text-embedding-ada","whisper","dall-e","tts-1","omni-moderation","openai"], displayName: "OpenAI", icon: "OpenAI" },
  kling: { modelPatterns: ["kling"], nameAliases: ["kling","可灵"], displayName: "Kling", icon: "Kling.Color" },
  // "inkling" contains "kling", so these need strongPatterns to outrank Kling.
  thinkingmachines: { modelPatterns: ["inkling"], strongPatterns: ["inkling"], nameAliases: ["thinking machines","thinkingmachines","tml"], displayName: "Thinking Machines" },
  ...
  meta: { modelPatterns: ["llama","muse-glimmer","muse-spark"], strongPatterns: ["muse-glimmer","muse-spark"], displayName: "Meta", icon: "Meta.Color" },
  nvidia: { modelPatterns: ["nemotron","riva-translate","ising-calibration","nvclip","nv-embed","nemoretriever","nvidia/vila","nvidia/neva"], strongPatterns: ["nemotron","riva-translate","ising-calibration","nvclip","nv-embed","nemoretriever"], displayName: "NVIDIA", icon: "Nvidia.Color" },
  ...
  cohere: { modelPatterns: ["command-","c4ai-","cohere","aya-","tiny-aya","north-mini","embed-english-","embed-multilingual-","embed-v4","rerank-v3"], displayName: "Cohere", icon: "Cohere.Color" },
  ...
  lorebary: { modelPatterns: ["lorellm"], strongPatterns: ["lorellm"], nameAliases: ["lorebary"], displayName: "LoreBary" },
  ...
  internlm: { modelPatterns: ["internlm","internvl","intern-s","intern-latest","atria-dawn"], strongPatterns: ["internlm","internvl","intern-s","atria-dawn"], nameAliases: ["internlm","intern","书生","浦语","shanghai ai"], displayName: "InternLM", icon: "InternLM" },
  ...
  amazon: { modelPatterns: ["nova","polly","titan-","kiro"], nameAliases: ["amazon","aws"], displayName: "Amazon" },
  ...
  dotsstudio: { modelPatterns: ["dots-3","dots3","dots-vlm","dots-ocr"], strongPatterns: ["dots-3","dots3"], nameAliases: ["dots studio","dots-studio","dotsstudio","rednote","xiaohongshu"], displayName: "Dots Studio" },
  moondream: { modelPatterns: ["moondream"], strongPatterns: ["moondream"], nameAliases: ["moondream","m87","m87 labs"], displayName: "Moondream" },
  slai: { modelPatterns: ["grape-2","grape2"], strongPatterns: ["grape-2","grape2"], nameAliases: ["sl-ai","slai","skinnertopia"], displayName: "SL-AI" },
  ...
  stealth: { modelPatterns: ["ox-alpha", "union-alpha", "space-bunny"], strongPatterns: ["ox-alpha", "union-alpha", "space-bunny"], nameAliases: ["stealth"], displayName: "Stealth" },
