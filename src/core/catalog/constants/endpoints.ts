...
export const ENDPOINT_DEFAULT_PATHS: Record<string, string> = {
  ...
  "typesafe-decisions": "/v1/decisions",
};
...
// prettier-ignore
export const NON_TESTABLE_ENDPOINT_TYPES = new Set(["image-generation","dall-e-3","embeddings","openai-video","jina-rerank","aihorde","moderations","typesafe-decisions"]);
